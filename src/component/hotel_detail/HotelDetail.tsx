...
const hotel: IHotel = {
  ...
  rooms: [
    ...
    },
    {
      ...
      baseOccupancy: 2,
      maxOccupancy: 4,
      description: '공원 뷰, 넥플릭스 제공, 조식 미포함',
    },
    {
      room_id: 3,
      type: '패밀리룸',
